...
const Episode = props => {
    ...
    return (
        <div className="container">
                ...
                <div className="col-md-12 mt-4 pt-4">
                    <form>
                        <div className="form-group">
                            <input type="text" className="form-control" placeholder="What are u' looking for @lso?" value={searchTerm} onChange={handleChange} />
                        </div>
                    </form>
                </div>
            ...
            <button onClick={() => actions.getEpisodes(store.episodes.info.next)}>NExt</button>
            <button onClick={() => actions.getEpisodes(store.episodes.info.prev)}>prev</button>
